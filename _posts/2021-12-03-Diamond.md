...
## 2. Datasets
[Kaggle](https://www.kaggle.com)에 있는 [Diamonds](https://www.kaggle.com/shivam2503/diamonds)데이터셋을 사용하기로 했다. 이 데이터셋은 약 54,000개의 다이아몬드의 가격, 무게(단위: 캐럿), 가공 상태, 색, 투명도, 길이, 너비, 높이 등에 대한 데이터를 포함한다.
## 3. Methodology
